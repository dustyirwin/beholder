...
ebay={
    ...
    'categories': [{'name': 'Antiques', 'id': '20081'},{'name': 'Art', 'id': '550'},
    ...
    'search_filters': [        {'name': 'New', 'value': True},
        {'name': 'BIN', 'value': True},
...
walmart={
    'market_keywords': '',
    'search_enabled': False,
    'categories': [            {'name': 'Arts, Crafts & Sewing', 'id': '1334134'}, {'name': 'Auto & Tires', 'id': '91083'},
...
amazon={
    'market_keywords': '',
    'search_enabled': False,
    'categories': [            {'name': 'Apparel', 'id': 'Apparel'},{'name': 'Appliances', 'id': 'Appliances'},
    ...
    'search_filters': [{'name': 'Prime', 'value': False},
        {'name': 'New', 'value': True}, ], }
...
class Query(models.Model):
    ...
    market_data = JSONField(default=dict)
